...
beta_10_2 = \hlkwd{t_test_errors}(func = function \hlkwd{rbeta}(n, 10,2), true_mean = 10/12)
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in parse(text = input): <text>:20:24: unexpected '='\\\#\# 19: \ \ \}\\\#\# 20: \ \ return(c(Left-tailed =\\\#\# \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textasciicircum{}}}\end{kframe}
\end{knitrout}
